      ...
      {timeUnits.map((unit, index) => (
        ...
        >
          <div className="relative flex flex-col items-center justify-center">
            ...
            {/* Main content */}
            <div className="relative flex flex-col items-center justify-center p-4 md:p-6 bg-white/80 backdrop-blur-sm border border-white/40 rounded-full shadow-2xl hover:shadow-3xl transition-all duration-500 hover:scale-110 hover:-translate-y-2">
